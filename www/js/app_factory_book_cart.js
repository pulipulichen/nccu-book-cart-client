/*global DB:false */
app.factory("factory_book_cart", function () {
    
    this.load_lists =  function ($scope, _callback) {
    ...
    this.load_todo_list = function ($scope, _callback) {
        ...
        this.load_completed_list= function ($scope, _callback) {
        ...
        this.clear_list= function ($scope, _callback) {
        ...
        this.clear_todo_list= function ($scope, _callback) {
            ons.notification.confirm({
        ...
        this.clear_completed_list= function ($scope, _callback) {
            ons.notification.confirm({
                message: "確定要清空歷史記錄嗎？",
                callback: function (_answer) {
                    //console.log(_answer);
        ...
        this.add= function ($scope, _isbn, _callback) {
        ...
        this.has_item_notify= function ($scope, _item_list, _callback) {
...
//        }
        ...
        this.request_add= function ($scope, _isbn, _callback) {
            //console.log(_isbn);
            modal.show();
            alert("request_add 1");
