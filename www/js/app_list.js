app.list = {};
app.list.load_lists = function ($scope, _callback) {
...
app.list.load_todo_list = function ($scope, _callback) {
...
app.list.load_completed_list = function ($scope, _callback) {
...
app.list.clear_list = function ($scope, _callback) {
...
app.list.clear_todo_list = function ($scope, _callback) {
    ons.notification.confirm({
...
app.list.clear_completed_list = function ($scope, _callback) {
    ons.notification.confirm({
        message: "確定要清空歷史記錄嗎？",
        callback: function (_answer) {
            //console.log(_answer);
...
app.list.add = function ($scope, _isbn, _callback) {
...
app.list.has_item_notify = function ($scope, _item_list, _callback) {
...
app.list.request_add = function ($scope, _isbn, _callback) {
    //console.log(_isbn);
    modal.show();
    alert("request_add 1");
...
app.list.has_item = function ($scope, _isbn, _callback) {
    if (_isbn === "") {
        _callback(false);
        return;
    }
...
app.list.open_map = function ($scope, _location) {
...
app.list.complete_item = function ($scope, _id, _callback) {
...
app.list.undo_item = function ($scope, _id, _callback) {
    var _time = (new Date()).getTime();
...
app.list.search = function ($scope) {
    $scope.add();
};

app.list.scan_barcode = function ($scope) {
